            ...
            <?php
               ...
               $query = "SELECT products.id,products.name,products.description,products.price,categories.name as category_name FROM products JOIN categories on products.category_id = categories.id WHERE category_id=:category_id  ORDER BY id DESC
